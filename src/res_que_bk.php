                            ...
                            <td>
                                ...
                                <div class="btn-group dropright tb-drop">
                                    ...
                                    <?php elseif($question['question_type']=='yes-no'): ?>
                                        <select class="form-select" name="check_<?php echo $question['question_res_id']; ?>">
                                            <option value="0"><?php echo $trans->phrase('please_select_ticket'); ?></option>
											<option value="1" class="form-check-input yes-check" data-tip_enabled="<?php echo $question['question_tip_on_yes']; ?>" <?php if($yes_check) echo("selected"); ?> <?php echo (!$user_edit_permission) ? 'disabled' : ''; ?> ><?php echo $trans->phrase("user_ticket_phrase12"); ?></option>
                                            <option value="1" <?php if($no_check) echo("selected"); ?> 
 ...
 <input type="hidden" name="pageNum" id="pageNum" value="<?php echo $pageNum; ?>"/>
    ...
    <div class="w3-modal-content">
        ...
        <div class="w3-button-holder">
		    ...
		    <div style="width:100%;text-align:center;">
		        <?php if($user_edit_permission): ?>
        <button id="save_ticket" class="btn btn-success mb-3 ml-3" data-ticket_id="<?php echo $ticket_id; ?>"> <?php echo $trans->phrase("user_ticket_phrase15"); ?>
        </button>
        <?php endif; ?>
    </div>
    	<!-- Modal -->
            ...
            $.ajax({
                ...
                if (data['status'] == 'success') {
                    ...
                    swal.fire({
                        ...
                        var totalAnswerIdsArr = $("#answerIds").val().split(",");
