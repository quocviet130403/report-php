...
if (isset($_SESSION['account-type']) && ((isset($_GET['id']) && $_GET['id'] > 0) || (isset($_POST['id']) && $_POST['id'] > 0))) {
    ...
    if ($report) {
        ...
        $content_prefix_html = "<body style='background-image:url(\"https://beta.nogd.no/images/bakgrunn-mal.png\"); background-image-resize: 6;'>" . $page_footer . '<div>';
        $content_subfix_html = '</div></body></html>';

        $normal_prefix_html = "<body style='background-color: #d7dbdd; background-image:url(\"https://beta.nogd.no/images/bakgrunn-mal.png\"); background-image-resize: 6;'>";
