    ...
    <script type="module">
        ...
        export default function define(runtime, observer) {
            ...
            const fileAttachments = new Map([
                ...
                ["flare-2.json", {
                    url: new URL("pdf_chart_record.php", import.meta.url),
    ...
    <script>
        $(document).ready(function() {
            ...
            function initReport() {
                ...
                let ticket = document.getElementById("ticket_id_data").value
                report['graph'] = {
                    "radar_graph": graph1,
                ...
                if (submission) {
                    $.ajax({
                        ...
                        if (data == 'success') {
                            console.log('saved');
                            window.location.assign("http://www.alexsol.me/report_types/pdf_report_main.php?id="+ticket);
                        } else {
                            console.log('failed');
                            window.location.assign("http://www.alexsol.me/user/index.php?route=ticket&id="+ticket+"&page=question");
                        }
                    });
                }
                */
