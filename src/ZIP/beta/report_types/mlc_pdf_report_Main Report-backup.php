...
if (isset($_SESSION['account-type']) && isset($_GET['id']) && $_GET['id'] > 0) {
    ...
    if ($graph->rowCount() > 0) {
        ...
        //
        //    $sqlData = "SELECT * FROM mlreport_format_content WHERE report_format_id = {$report_format['report_format_id']} AND report_lang_code='{$_SESSION['trans']}'";
        //
