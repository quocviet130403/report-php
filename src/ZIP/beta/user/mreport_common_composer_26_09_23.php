            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="tableModalData">
                    ...
                    ?>
                        ...
                        <!-- Graph 1-->
                        <div class="card text-center mb-2 d-flex align-items-center d-none">
                            <div class="card-body radar-graph" style="max-width: 900px;" id="radar_graph_1">
                                ...
                                <?php foreach ($categories as $category) : ?>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label" for="radar1_category_<?php echo $category['category_id']; ?>">
                                            <?php //$checked = ($category['category_id'] == 1 || $category['category_id'] == 9 || $category['category_id'] == 11 || $category['category_id'] == 13 || $category['category_id'] == 14) ? "checked": ""; 
                                            ?>
                                            <input class="form-check-input graph-label" hidden type="checkbox" id="radar1_category_<?php echo $category['category_id']; ?>" data-category="<?php echo $category['category_id']; ?>" value="<?php echo $category['category_name']; ?>" checked><?php echo $category['category_name']; ?></label>
                                    </div>
                                <?php endforeach; ?>
                                <br><br>
                                <!-- <select id="choose_graph_res1" class="d-none">
                                    <option value="1">
                                        <?php 
                                        // echo $trans->phrase('user_composer_phrase25'); 
                                        ?>
                                    </option>
                                    <option value="2">
                                        <?php 
                                        // echo $trans->phrase('user_composer_phrase33'); 
                                        ?>
                                    </option>
                                </select> -->
                                <!-- <button type="button" id="draw_graph_res_1" class="btn btn-primary btn-sm"><?php echo $trans->phrase('user_composer_phrase27'); ?></button>
...
<script>
    console.log("##########################################");
    // console.log(document.querySelector("#composer_text_1").nextElementSibling);
    console.log(document.querySelector("#composer_text_1").value.replace( /(<([^>]+)>)/ig, ''));
    console.log("##########################################");
</script>
<script type="module">
