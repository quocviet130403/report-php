        ...
        <div class="tos-ctn">
            ...
            <form>
                <div class="form-group">
                    <label for="tos_selection" class="tos-section-title"><?php echo $trans->phrase('user_tos_phrase3'); ?></Label>
                ...
                <div class="tos-editor-ctn">
                    ...
                    <button class="tos_save btn btn-success mb-2 mt-2" data-company_id="<?php echo ($tos_company)? $tos_company['company_id']: ''; ?>" data-lang_code="<?php echo $lang['lang_code']; ?>">
