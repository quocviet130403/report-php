...
if (isset($_SESSION['account-type']) && ((isset($_GET['id']) && $_GET['id'] > 0) || (isset($_POST['id']) && $_POST['id'] > 0))) {
    ...
    if ($report) {
        ...
        $front_prefix_html = "<body style='font-family: \"Montserrat\", sans-serif; background-image:url(\"https://beta.nogd.no/images/duo_report.jpg\"); background-image-resize: 6;'>" . $page_footer . '<div>';
        ...
        $normal_prefix_html = "<body style='background-color: #d7dbdd; background-image:url(\"https://beta.nogd.no/images/lp_2.png\"); background-image-resize: 6;'>" . $page_footer . '<div>';
