...
if (isset($_SESSION['account-type']) && ((isset($_GET['id']) && $_GET['id'] > 0) || (isset($_POST['id']) && $_POST['id'] > 0))) {
        ...
        if ($report['front_page']['enabled']) {
            ...
            if ($report['front_page']['logo']) {
                ...
                if ($company['upload_company_img']) {
                    $html .= '<img src="https://beta.nogd.no/images/company_logo/' . $company['upload_company_img'] . '" style="height: 100px" />';
    ...
    if ($report) {
        ...
        $normal_prefix_html = "<body style='background-color: #d7dbdd; background-image:url(\"https://beta.nogd.no/images/2.png\"); background-image-resize: 6;'>";
        $normal_subfix_html = '</body></html>';
        ...
        $intro_prefix_html_last .= '<body style="background-color: #fff; background-image:url(\'https://beta.nogd.no/images/4.png\'); background-image-resize: 6;"><div>';
        ...
        if ($report['intro_text']['enabled']) {
            ...
            $page_header = page_header_last('intro.png', 'left');
            $mpdf->WriteHTML($intro_prefix_html_last . $page_header . $intro_text . $page_footer . $intro_subfix_html);
        }
        ...
        if ($report['free_text4']['enabled']) {
            ...
            $page_header = page_header('9.png', 'left');
        ...
        if ($report['free_text13']['enabled']) {
            ...
            $mpdf->WriteHTML($intro_prefix_html_last . $page_header . $free_text13 . $page_footer . $intro_subfix_html);
        }
