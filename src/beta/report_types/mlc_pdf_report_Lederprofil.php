...
if (isset($_SESSION['account-type']) && ((isset($_GET['id']) && $_GET['id'] > 0) || (isset($_POST['id']) && $_POST['id'] > 0))) {
    ...
    function page_header($img, $pos)
    {
        if ('NOHEADER' == $img) {
            ...
            $html .= '<div style="margin-top: 60px">
                        ...
                        <img src="https://beta.nogd.no/images/32.png" />
                    </div>';
            $html .= '</htmlpageheader>';
    ...
    function free_text8($report, $trans, $index)
    {
        ...
        if ($report['free_text8']['enabled']) {
            ...
            $html .= '<div style="width: 100%; height: 150px;"></div>';
    ...
    if ($report) {
        ...
        $front_prefix_html = "<body style='font-family: \"Montserrat\", sans-serif; background-image:url(\"https://beta.nogd.no/images/bg-2.png\"); background-image-resize: 6;'>";
        $front_subfix_html = '</body></html>';

        $content_prefix_html = "<body style='background-image:url(\"https://beta.nogd.no/images/lp_2.png\"); background-image-resize: 6;'>" . $page_footer . '<div>';
        $content_subfix_html = '</div></body></html>';

        $normal_prefix_html = "<body style='background-color: #d7dbdd; background-image:url(\"https://beta.nogd.no/images/lpr_29.png\"); background-image-resize: 6;'><div>";
        ...
        $intro_prefix_html_lastpage .= '<body style="background-color: #fff; background-image:url(\'https://beta.nogd.no/images/32.png\'); background-image-resize: 6;"><div>';
