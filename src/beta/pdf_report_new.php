    ...
    function front_page($report, $user, $company, $ticket, $trans)
    {
        ...
        if ($report['front_page']['enabled']) {
            ...
            if ($report['front_page']['username']) {
                ...
                $html .= "<div id='three'>" . $user['user_name'] . "</div>";
            }
            $html .= "<div id='four'>";
            if ($report['front_page']['company_name']) {
                ...
                $html .= '<p>' . $company_name . '<br/>' . date('j') . '.' . strtolower($months[intval(date('m')) - 1]) . ' ' . date('Y') . '</p>';
            }
            ...
            if ($report['front_page']['ticket_id']) {
                ...
                $html .= '<p>Ticket #' . $ticket['ticket_id'] . '<br/>' . date('j') . '.' . strtolower($months[intval(date('m')) - 1]) . ' ' . date('Y') . '</p>';
            }
