...
if(isset($_SESSION['account-type']) && isset($_GET['id']) && $_GET['id'] > 0){
    ...
    function front_page($report, $user, $company, $ticket, $trans){
        ...
        if($report['front_page']['enabled']){
            $html .= "<html><body style='background-image:url(\"/images/front-background.jpg\"); background-image-resize: 6;'>";
            ...
            if($report['front_page']['company_name']){
                ...
                $html .= "<div style='width: 100%; height: 25px;'></div>";
                $html .= "<h2 style='text-align: center; color: black; font-style: italic;'>".$company_name."</h2>";
            }
            if($report['front_page']['ticket_id']){
                $html .= "<div style='align: justify; color: black; background-color:white;margin-left: 20%;margin-right: 20%'>".$trans->phrase('pdf_report_phrase10').": ".$ticket['ticket_name']."</div>";
                // exit($html);
            }
    ...
    function addContent($report, $trans){
    ...
    if($report){
        ...
        $html = "<html><body style='background-image:url(\"/images/bakgrunn-mal.png\"); background-image-resize: 6;line-height:12px;'>" . $header_footer . "<div style='padding-left:62px;padding-right:56px;'>" . $free_text1 . $intro_text . $free_text2 . $conflict . $free_text3;
        ...
        // exit($html);
        //Generate PDF
        // file_put_contents('php://stderr', print_r($html, TRUE));exit;
