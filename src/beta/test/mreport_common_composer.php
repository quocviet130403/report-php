...
if(isset($_GET['id'])):
    ...
    $Database = new Database();
        ...
        $reports = $Database->get_multiple_data('ticket_id', $_GET['id'], 'creport');
        if($reports){
    ...
    <div class="col-12 creport-dcomposer">
        ...
        <div class="row user-content-row">
            <div class="col-12">
                ...
                <br>
                <button type="button" id="save_mlreport_common_format" class="btn btn-success"><?php echo $trans->phrase('user_composer_phrase24'); ?></button>
            </div>
        </div>
    </div>
</div>
