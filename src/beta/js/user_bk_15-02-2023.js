        ...
        if (submission) {
            $.ajax({
                ...
                if (data == 'success') {
                    ...
                    window.location.href = '?route=ticket&id=' + ticket_id_post + '&page=question';
                } else
                    alert(data);
            });
        }
        ...
        for (let x = 0; x < graph_category.length; x++) {
            ...
            for (let y = 0; y < questions.length; y++) {
                ...
                if (questions[y]['category_id'] == graph_category[x]) {
                    console.log('qus_type : '+responses[question_id]['type']+', mcq :' + questions[y]['question_id'] + ', weight_yes :' + weight_yes + ', answer : ' + parseInt(responses[question_id]['answer']));
                    //Main Question
                    if (responses[question_id]['type'] == 'mcq') {
                        ...
                        if (value == 6) {
                            ...
                            value = parseInt(responses[question_id]['answer']);
                        }
                        score += value;
