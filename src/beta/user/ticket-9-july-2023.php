            ...
            ?>
                ...
                <div class="card">
                                        ...
                                        <div class="row user-content-row">
                                            <div class="col-12">
                                                <form>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <select name="resp_invite_type" id="resp_invite_type" style="background: #ced4da;border: 0px;padding:10px"  <?php if ($user_edit_permission || $company_edit_permission || $consultant_edit_permission) {  }else { echo 'disabled'; } ?>>
                                                        ...
                                                        <input type="text" id="res" style="height: 44px;" placeholder="<?php echo $trans->phrase("user_ticket_responder_placeholder"); ?>" class="form-control single_resp" <?php if ($user_edit_permission || $company_edit_permission || $consultant_edit_permission) {  }else { echo 'disabled'; } ?>>
                                                        
                                                        <span class="file-input-wrapper bulk_resp d-none form-control" style="height: 44px;" >
                                                            <span class="file-name">Select file</span>
                                                            <input type="file" id="multiple_responder"name="multiple_responder" required <?php if ($user_edit_permission || $company_edit_permission || $consultant_edit_permission) {  }else { echo 'disabled'; } ?>>
                                                        </span>

                                                        <input type="hidden" id="res_ticket_id" value="<?php echo $_GET['id'] ?>" class="form-control">

                                                        <button id="btn_res1" class="btn btn-success single_resp" <?php if ($user_edit_permission || $company_edit_permission || $consultant_edit_permission) { } else { echo 'disabled';} ?>>
                                                            <?php echo $trans->phrase("user_ticket_invite_text"); ?>
                                                        </button>

                                                        <button id="invite-bulk-responder" class="btn btn-success bulk_resp btn-sm btn-flat w-full d-none"  <?php if ($user_edit_permission || $company_edit_permission || $consultant_edit_permission) {  }else { echo 'disabled'; } ?>><?php echo $trans->phrase("user_ticket_invite_bulk_responder"); ?></button>
                                                    </div>
                                                </form>
                                        ...
                                        if ($respond_tickets) { ?>
                                            ...
                                            ?>
                                                    <div class="row">
														...
														<div  class="col-sm-12 col-md-2" style="padding-top:2px;">
														
														 <button data-responder_id="<?php echo $respond_ticket['responder_id']; ?>" class="response_delete">
                       Delete
                    </button>
                                ...
                                <?php echo $trans->phrase('user_ticket_phrase54'); ?>
                                            ...
                                            <?php //if ($ticket['ticket_response'] && $ticket['ticket_status'] == 'closed' && 1 == 2) { ?>
                                                ...
                                                <button data-bs-toggle="modal" onclick="return false;" data-bs-target="#graphModal" class="btn btn-info btn-sm"><?php echo $trans->phrase('add_graph'); ?> </button>
                                                                                ...
                                                                                <?php foreach($categories as $category): ?>
                                                                                    <div class="col-sm-12 col-md-3 mb-2">
                                                                                        <label class="form-check-label" for="radar1_category_<?php echo $category['category_id']; ?>">
                                                                                            ...
                                                                                            <input class="graph-label" type="checkbox" id="radar1_category_<?php echo $category['category_id']; ?>" data-category="<?php echo $category['category_id']; ?>" value="<?php echo $category['category_name']; ?>" checked> <?php echo $category['category_name']; ?></label>
                                                                                    </div>
                                                                                <?php endforeach; ?>
                                                                            </div>
                    ...
                    <div style="width:100%;text-align:center;">
                        <?php if (($user_edit_permission || $consultant_edit_permission || $company_edit_permission) && $ticket['Created_by'] == $_SESSION['account-type']) : ?>
                            <?php if($permissions['canAnalysis']): ?>
                            ...
                            <?php 
                                ...
                                if($canCloseAnalysis['status'] === 'true'): 
                            ?>
                            <?php
                            //hide close button until all question not completed.
                            if ($answer_count >= $countNotFollowUpQuestion || $canCloseAnalysis['status'] === 'true') {
                            ?>
...
elseif ($_SESSION['account-type'] == 'user' || $_SESSION['account-type'] == 'company' || $_SESSION['account-type'] == 'consultant') :
    ...
    margin: 0px 11px;">
                        ...
                        <div class="col-xs-6">
                            <button id="request_from_ticket" class="btn btn-success mb-3 ml-3" data-ticket_id="">This is atest for what it is using for
