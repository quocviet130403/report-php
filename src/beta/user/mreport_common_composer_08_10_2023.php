                        ...
                        <div class="card text-center mb-2 d-flex align-items-center">
                            ...
                            <div class="row tableRow">
                                <div class="col-md-4">
                                    ...
                                    <a href="#" id="export_excel" onclick="exporttoexcel(event)"><i class="fas fa-download"></i></a>
...
// 
  ...
  <?php
    ...
    $sql1="SELECT question_id FROM question_content WHERE lang_code='". $_SESSION['trans']."' " ;
    $rss1=mysqli_query($conn,$sql1);
    while($row1=mysqli_fetch_assoc($rss1)){
?>
 <option value="<?= $row1['question_id'] ?>"><?= $row1['question_id']; ?></option>
  <?php  }
  ?>
</select>
