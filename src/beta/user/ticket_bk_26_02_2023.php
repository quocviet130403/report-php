    ...
    <div class="row user-content-row">
                        ...
                        $(document).ready(function() {
                                ...
                                $('#btn_res1').click(function (event) {
                                    event.preventDefault();
                                       let email = $('#res').val();
                                       let companyName = "<?php echo $ticket_company['company_name'];?>";
                                       ...
                                       if(email != ''){
                                                $.ajax({
                                                    ...
                                                    type: 'POST',
                                                    data: {'sign': 'res_form', 'email': email , 'companyName': companyName , 'res_ticket_id': res_ticket_id}
                                                }).done(function (data) {
       ...
       if($_SESSION['account-type'] == 'user' || $_SESSION['account-type'] == 'super_admin' || $_SESSION['account-type'] == 'company' || $_SESSION['account-type'] == 'consultant'){
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-12 col-md-1 text-danger text-center w-low-dsk">Link</div>
            <div class="col-sm-12 col-md-1 text-danger text-center w-low-dsk">Response</div>
...
//            print_r($respond_ticket_data['ticket_response']);
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-1 w-low-dsk w-low-dsk-text text-center"><span id="responderReviewLink_<?php echo $respond_count; ?>" class="d-none"></span></div>
            <div class="col-sm-12 col-md-9"  style="padding-top:6px;">
                <?php
...
<!--                        </a>-->
                        ...
                        ?>
                            <a href="<?php echo SITE_URL ?>/report_types/mlc_pdf_report_<?php echo str_replace(' ', '%20', $report['report_title']); ?>.php?id=<?php echo $ticket['ticket_id']; ?>&com=1" class="btn btn-success btn-sm mb-1">
                                <i class="fas fa-download"></i>
                                Download common report
                            </a>
                        <?php } ?>
                        ...
                        data-question_no_follow_up="<?php echo $question['question_no_follow_up']; ?>">
                            ...
                            <td>
                                ...
                                <div class="btn-group dropright tb-drop">
                                    <select class="question_type_select form-select" onchange="setProgBar('<?php $question['question_id'] ?>')"> >
                                        <?php if($question['question_type'] == 'mcq'):?>
                                            <option value="0" ><?php echo $trans->phrase('please_select_ticket'); ?></option>
                                            <option value="1" data-tip="no" data-tip_enabled="<?php echo $question['question_tip_on_no']; ?>" <?php if($check_1) echo("selected"); ?> ><?php echo $question_data['question_option1']; ?></option>
                                            <option value="2" data-tip="no" data-tip_enabled="<?php echo $question['question_tip_on_no']; ?>" <?php if($check_2) echo("selected"); ?>><?php echo $question_data['question_option2']; ?></option>
                                            <option value="3" data-tip="" data-tip_enabled="0" <?php echo ($check_3)? 'checked': ''; ?> <?php if($check_3) echo("selected"); ?>><?php echo $question_data['question_option3']; ?></option>
                                            <option value="4" data-tip="yes" data-tip_enabled="<?php echo $question['question_tip_on_yes']; ?>" <?php if($check_4) echo("selected"); ?>><?php echo $question_data['question_option4']; ?></option>
                                            <option value="5" data-tip="yes" data-tip_enabled="<?php echo $question['question_tip_on_yes']; ?>" <?php if($check_5) echo("selected"); ?>><?php echo $question_data['question_option5']; ?></option>
                                            <option value="6" data-tip="yes" data-tip_enabled="<?php echo $question['question_tip_on_yes']; ?>" <?php if($check_6) echo("selected"); ?>><?php echo $question_data['question_option6']; ?></option>
                                        <?php elseif($question['question_type']=='yes-no'): ?>
                                            <option value="0"><?php echo $trans->phrase('please_select_ticket'); ?></option>
                                            <option value="1" data-tip_enabled="<?php echo $question['question_tip_on_yes']; ?>" <?php if($yes_check) echo("selected"); ?>><?php echo $trans->phrase("user_ticket_phrase12"); ?></option>
                                            <option value="1" data-tip_enabled="<?php echo $question['question_tip_on_no']; ?>" <?php if($no_check) echo("selected"); ?>><?php echo $trans->phrase("user_ticket_phrase13"); ?></option>
                                        <?php endif; ?>
                                    </select>
                                </div>
                            </td>
...
<div class="card">
    <div class="card-body p-3">
        <div class="row user-content-row">
            ...
            <div class="col-12 mt-3">
                <form>
                    ...
                    <select id="user" name="user" class="form-select" aria-label="Select User">
        ...
        <div class="row user-content-row">
            <button id="create_ticket_company" class="btn btn-success mb-3 ml-3" data-ticket_id="">
                <?php echo $trans->phrase("user_ticket_phrase24"); ?>
            </button>
        </div>
    </div>
    ...
    <div class="card-body p-3">
        <div class="row user-content-row">
            ...
            <div class="col-12 mt-3">
                <form>
                    <label class="user"><?php echo $trans->phrase("user_ticket_phrase60"); ?></label>
                    <label><input type="radio" name="options" value="company"> <?php echo $trans->phrase("user_ticket_phrase61"); ?></label>
                    <label><input type="radio" name="options" value="user"> <?php echo $trans->phrase("user_ticket_phrase62"); ?></label>
                </form>
            </div>
        </div>
