...
if (isset($_SESSION['account-type']) && ((isset($_GET['id']) && $_GET['id'] > 0) || (isset($_POST['id']) && $_POST['id'] > 0))) {
        ...
        if ($report['front_page']['enabled']) {
            ...
            if ($report['front_page']['logo']) {
                ...
                if ($company['upload_company_img']) {
                    $html .= '<img src="'.SITE_URL.'/images/company_logo/' . $company['upload_company_img'] . '" style="height: 100px" />';
    ...
    if ($report) {
        ...
        $front_prefix_html = "<body style='font-family: \"Montserrat\", sans-serif; background-image:url(\"../images/bg-1.png\"); background-image-resize: 6;'>";
        ...
        $normal_prefix_html = "<body style='background-color: #d7dbdd; background-image:url(\"../images/2.png\"); background-image-resize: 6;'>";
