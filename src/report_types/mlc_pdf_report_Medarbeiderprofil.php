...
if (isset($_SESSION['account-type']) && ((isset($_GET['id']) && $_GET['id'] > 0) || (isset($_POST['id']) && $_POST['id'] > 0))) {
    ...
    function page_header($img, $pos)
    {
        if ('NOHEADER' == $img) {
            ...
            $html .= '<div style="margin-top: 60px">
                            ...
                            <img src="'.SITE_URL.'/images/epr_bg.png" />
                        </div>';
            $html .= '</htmlpageheader>';
    ...
    function front_page($report, $user, $company, $ticket, $trans)
    {
        ...
        if ($report['front_page']['enabled']) {
            ...
            $html .= "<div style='width: 100%; height: 350px;'></div>";
            ...
            $html .= 'Denne rapporten er utarbeidet av:';
...
//echo $html;exit;
    ...
    function free_text4($report, $trans, $index)
    {
        ...
        if ($report['free_text4']['enabled']) {
            ...
            $html .= '<div style="margin-left: 25px; margin-right: 20px;margin-top:110px;">';
            $html .= '<div style="text-align: center"><img src="'.SITE_URL.'/images/graph.png" width="500" height="500" alt="graph.png" /></div>';
            $html .= '<div style="margin-top:20px;">' . htmlspecialchars_decode($report['free_text4']['text']) . '</div>';
            $html .= '</div>';
    ...
    if ($report) {
       ...
       /* $front_prefix_html = "<body style='font-family: \"Montserrat\", sans-serif; background-image:url(\''.SITE_URL.'/images/emp_report.jpg\'); background-image-resize: 6;'>" . $page_footer . '<div>';
        $front_subfix_html = '</div></body></html>';

        $normal_prefix_html = "<body style='background-color: #d7dbdd; background-image:url(\"'.SITE_URL.'/images/epr_index.png\"); background-image-resize: 6;'>" . $page_footer . '<div>';
        $normal_subfix_html = '</div></body></html>';*/
        $front_prefix_html = "<body style='font-family: \"Montserrat\", sans-serif; background-image: url(" . SITE_URL . "/images/emp_report.jpg); background-size: cover;'>" . $page_footer . '<div>';
$front_subfix_html = '</div></body></html>';

$normal_prefix_html = "<body style='background-color: #d7dbdd; background-image: url(" . SITE_URL . "/images/epr_index.png); background-size: cover;'>" . $page_footer . '<div>';
$normal_subfix_html = '</div></body></html>';
        ...
        $intro_prefix_html .= '<body style="background-color: #fff; background-image:url(\''.SITE_URL.'/images/white.png\'); background-image-resize: 6;"><div>';
        ...
        if ($report['free_text7']['enabled']) {
            $mpdf->AddPage('P', '', '', '', '', 0, 0, 50, 10, 0, 0);
            $page_header = page_header('epr_10.png', 'left');
        ...
        if ($report['free_text14']['enabled']) {
            $mpdf->AddPage('P', '', '', '', '', 0, 0, 53, 10, 0, 0);
            $page_header = page_header('epr_15.png', 'right');
