            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="tableModalData">
                    ...
                    ?>
                        ...
                        <!-- Graph 1-->
                        <div class="card text-center mb-2 d-flex align-items-center">
                            <div class="card-body radar-graph" style="" id="radar_graph_1">
                            <div class="row">
                                <div class="col-md-4"></div>
                                <div class="col-md-4">
                                    <select id="choose_user_ress" class="form-select mx-3" style="width:150px;margin-bottom: 20px;" onchange="createDataTable(this.value)">
                                    <option value="1">
                                        User
                                    </option>
                                    <option value="2">
